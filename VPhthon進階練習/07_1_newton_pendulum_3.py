...
all_rope = []
for i in range(5):
    all_ball.append(sphere(pos = (i*0.2-0.4, -0.5, 0),
                        radius=0.0999)) 
    all_rope.append(cylinder(pos = (i*0.2-0.4, 0, 0),
...
all_ball[4].pos = vector(0.4,0, 0) + all_rope[4].L * vector(sin(pi/6), -cos(pi/6), 0)
##all_ball[3].pos = vector(0.2,0, 0) + all_rope[3].L * vector(sin(pi/6), -cos(pi/6), 0)
##all_ball[2].pos = vector(0.0,0, 0) + all_rope[2].L * vector(sin(pi/6), -cos(pi/6), 0)
